...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      copilotModelHint: '当前可用的视觉模型示例：gpt-5.4 / gpt-5.5 / gpt-5.6-sol / gemini-3.5-flash / gemini-3.6-flash / grok-4.6 / kimi-k3',
    ...
    const en = {
      ...
      copilotModelHint: 'Current vision-capable examples: gpt-5.4 / gpt-5.5 / gpt-5.6-sol / gemini-3.5-flash / gemini-3.6-flash / grok-4.6 / kimi-k3',
